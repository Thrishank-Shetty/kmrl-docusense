const stats = [
  ["TOTAL DOCUMENTS PROCESSED", "11,936", "12% ↑ this month", "#0056B3"],
  ["EXTRACTION ACCURACY", "96.4%", "-", "#0056B3"],
  ["PENDING REVIEWS", "42", "Action required", "#EF4444"],
  ["SYSTEM STATUS", "Healthy", "", "#10B981"],
];
